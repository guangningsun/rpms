<template>
	<view class="s-page-wrapper is-100vh">
		<view class="is-33vh has-mgt-10">
			<view class="is-flex is-column is-justify-center  is-align-center is-height-80">
		...
		<view class="content">
			<view class="has-mglr-10 ">
				<view class=" has-mgtb-10 ">
					<input type="number" maxlength="11" v-model="login.phone" placeholder="请输入账号" class="is-input1 " @input="BindInput" data-val="phone" />
				</view>
		...
		<view class="is-20vh has-mgt-80 content">
			<navigator url="#" class=" has-radius is-right is-grey has-mgr-20" hover-class="">
                <text class="is-green is-left">注册</text>
                <text>忘记密码？</text>
				<text class="is-green">点击找回</text>
			</navigator>
